...
class Launcher
  ...
  def show_info
    puts "Which lawyers info you want to get?"
    puts "Write down one of these words: names, working time, numbers, websites, addressess or all to get all lawyers info's"
    choose = gets.chomp
    if choose == "names"
      lawyer_name
